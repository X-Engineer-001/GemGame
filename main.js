      ...
      for(var j=0;j<array[0];j++){//BladeCount
        if(j==0){//DrawBlade
          ...
          for(var k=0;k<array[i+1].length/2;k++){//x:350-70.71067811865476y:3501.25607396694702e-13,(*2)x:350-70.71067811865476y:3501.25607396694702e-13
            if(k==0){
              ctx.moveTo(AngleToCoordinateTopClockwise((CoordinateToAngleTopClockwise(thisblade[0],thisblade[1])+Math.PI*2*j/array[0])%(Math.PI*2),GetDistance(0,0,thisblade[0],thisblade[1])).x*scaling+x,AngleToCoordinateTopClockwise((CoordinateToAngleTopClockwise(thisblade[0],thisblade[1])+Math.PI*2*j/array[0])%(Math.PI*2),GetDistance(0,0,thisblade[0],thisblade[1])).y*scaling+y);
            }else{
              ctx.lineTo(AngleToCoordinateTopClockwise((CoordinateToAngleTopClockwise(thisblade[k*2],thisblade[k*2+1])+Math.PI*2*j/array[0])%(Math.PI*2),GetDistance(0,0,thisblade[k*2],thisblade[k*2+1])).x*scaling+x,AngleToCoordinateTopClockwise((CoordinateToAngleTopClockwise(thisblade[k*2],thisblade[k*2+1])+Math.PI*2*j/array[0])%(Math.PI*2),GetDistance(0,0,thisblade[k*2],thisblade[k*2+1])).y*scaling+y);
            }
          }
          ctx.fill();
        }
